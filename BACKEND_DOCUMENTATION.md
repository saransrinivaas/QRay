...
## 3. Algorithm Suite (`backend/app/algorithms/`)
...
## 5. Core Submodules (`backend/app/core/`)
...
2. **Persistent Disk Storage**: `backend/app/road_cache.json` persists road polylines across server restarts.
